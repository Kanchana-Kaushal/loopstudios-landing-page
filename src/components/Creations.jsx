...
function Creations() {
  ...
  return (
    <section
      className="mx-auto px-6 md:max-w-8/10"
      role="region"
    ...
    >
      <div className="mb-10 flex items-center justify-center md:justify-between">
        ...
        <button
          className="hover:bg-Black hidden items-center px-8 py-2 text-sm tracking-widest uppercase ring-1 transition-colors duration-75 ease-in hover:text-white md:flex"
      ...
      <div className="mt-8 flex justify-center">
        <button
          className="flex items-center px-4 py-2 text-sm tracking-widest uppercase ring-1 md:hidden"
          aria-label="See more creations"
        >
          see more
        </button>
      </div>
